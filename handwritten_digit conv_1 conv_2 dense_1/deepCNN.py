...
$ python deepCNN.py -r A -d A.pkl -e 20 -s small -t 1 2 3 4 5 > A.txt
# training domain B(tgt), load trained params from A.pkl
$ python deepCNN.py -r B -l A.pkl -d B.pkl -e 20 > B.txt
...
def build_mlp(input_var=None):
    ...
    l_out = lasagne.layers.DenseLayer(
        dense3, name='dense_output', num_units=10,
...
def load_largest_rank(A, O, rank):
    ...
    # all
    TARGET = ['conv_1','maxpool_1','conv_2','maxpool_2','conv_3','maxpool_3', 'dropout_1','dense_1','dense_2','dense_3', 'dense_output']
    # as defined in parameter
    # TARGET = transfer
